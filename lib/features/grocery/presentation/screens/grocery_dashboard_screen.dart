...
import '../../data/datasources/shop_service.dart';
  ...
  Widget _buildSearchBar() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF26AC73), // Updated Green
      ...
      child: Row(
        children: [
          ...
          IconButton(
            icon: const Icon(Icons.mic, color: Colors.white), // Using Icon instead of Image asset for simplicity
            onPressed: () {
